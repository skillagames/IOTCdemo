              ...
              <div className="flex flex-col items-center justify-center gap-4 py-12 text-center">
                ...
                <div className="space-y-1.5 mt-4">
                  ...
                  <p className="text-[10px] text-slate-500 font-bold max-w-[220px] leading-relaxed mx-auto">
                    You've cleared all your alerts. Refresh the page if you want
                    to check for any new device updates.
                  </p>
                </div>
          ...
          <div className="sticky top-[calc(168px+env(safe-area-inset-top))] z-20 w-full mt-12 mb-4 px-1">
            ...
            >
              ...
              <p className="text-[10px] text-slate-400 font-medium leading-relaxed mb-5">
                Detected {alerts.length} device signals requiring attention.
                Initiate renewal protocol to restore telemetry sync.
              </p>
